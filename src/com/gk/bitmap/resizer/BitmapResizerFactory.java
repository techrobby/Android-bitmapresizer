...
public class BitmapResizerFactory
{
	...
	{
		return scaleDownBitmapInDp(filename, reqWidthInDp, reqHeightInDp, Bitmap.Config.ARGB_8888, finResMoreThanReq, scaleUp);
	}

	public static Bitmap scaleDownBitmapInDp(String filename, int dimensionInDp, Bitmap.Config config)
	{
		int dimension = (int) (dimensionInDp * BitmapUtils.getDensityMultiplier());
		return scaleDownBitmap(filename, dimension, config);
	}

	public static Bitmap scaleDownBitmapInDp(String filename, int reqWidthInDp, int reqHeightInDp, Bitmap.Config config, boolean finResMoreThanReq, boolean scaleUp)
	{
	 ...
	 * @return
	 */
	public static Bitmap scaleDownBitmap(String filename, int dimension, Bitmap.Config config)
	{
	 ...
	 * @param finResMoreThanReq
	 * @param scaleUp
	 *            true if required width and height is greater than source file width and height And you want to scale
	 *            the resultant bitmap to required width and height
	 * @return
	 */
	public static Bitmap scaleDownBitmap(Resources res, int resId, int reqWidth, int reqHeight, Bitmap.Config config, boolean finResMoreThanReq, boolean scaleUp)
	{
	 ...
	 * @param reqWidth
	 *            Required bitmap width
	 * @param reqHeight
	 *            Required bitmap height
	 * @param finResMore
	 *            if true means returned Rect object will have width and height greater than or equal to required width
